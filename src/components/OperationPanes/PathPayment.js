...
export default function PathPayment(props) {
  return [
    <OptionsTablePair label="对方账户" key="destination">
      <PubKeyPicker
    ...
    <OptionsTablePair label="最大发送的数量" key="sendMax">
      <AmountPicker
    ...
    <OptionsTablePair label="中间的路径" key="path" optional="true">
      <ManualMultiPicker
    ...
    <OptionsTablePair label="目标资产" key="destAsset">
      <AssetPicker
    ...
    <OptionsTablePair label="数量" key="destAmount">
      <AmountPicker
